...
Dangnhapshipper.propTypes={

};
 function Dangnhapshipper() {
    ...
    <Box>
      ...
      >
        ...
        <DialogActions>
          ...
          <Button variant="contained" color="success"  onClick={handleClosednn}><Link  to="/shipper/donhang" >Tiếp tục</Link></Button>
        </DialogActions>
      </Dialog>
    </Box>
  );
...
export default Dangnhapshipper;