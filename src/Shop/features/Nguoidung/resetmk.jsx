...
export default function Resetmk() {
    ...
    const handlesua = async ()=>{
        ...
        && matkhau2.password == matkhau.password){
            await nguoidungApi.resetpass(token,matkhau.password);
            navigate(`/`);
        }
    }
    ...
    return (
        <div >
            <Box sx={{maxWidth: 600, mx: 'auto',p:2,pt:4,pb:4}}><Button variant="outlined" ><Link to="/">Quay về</Link></Button></Box>
