...
export default function Xacthucnv() {
    const [searchParams] = useSearchParams();
    let email = searchParams.get('email');
    let forgot = searchParams.get('forgot');
    return (
        <div >
            <Box sx={{maxWidth: 600, mx: 'auto',p:2,pt:4,pb:4}}><Button variant="outlined" >{!!forgot ? <Link to="/Manager/thongtincanhan">Quay về</Link>:<Link to="/products/dangky">Quay về</Link>}</Button></Box>
