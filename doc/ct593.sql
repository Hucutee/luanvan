...
('CT022', 'SP010', 'KT03', 86, 30000, 'Sen đá xứ lạnh', 'Sen đá hồng phấn', 'Trung', 'hong phan trung.jpg', 25),
...
INSERT INTO `don_hang` (`ma_dh`, `ma_kh`, `ma_pgg`, `ma_nv`, `ngay_dat_hang`, `dia_chi_giao`, `hinh_thuc_thanh_toan`, `tong_tien`, `trang_thai`, `nguoi_nhan`, `hoan_tien`) VALUES
('DH01', 'ND02', 'PGG1', 'ND01', '2022-10-08 13:33:10', 'P.An Khánh, Q.Ninh Kiều, TP.Cần Thơ', 1, 27000, 4, 'Bùi Công Minh, 0987654321', 0),
('DH010', 'ND03', 'PGG1', 'ND01', '2022-10-11 14:18:19', 'an khánh, ninh kiều, cần thơ', 1, 50000, 2, 'Bùi Công minh, 09848757485', 0),
('DH011', 'ND03', 'PGG2', 'ND01', '2022-10-11 14:20:04', 'an khánh, ninh kiều, cần thơ', 1, 320000, 6, 'Bùi Công minh, 0984885856', 0),
('DH012', 'ND03', 'PGG2', 'ND01', '2022-10-11 14:21:18', 'an khánh, ninh kiều, cần thơ', 1, 830000, 6, 'Bùi Công Minh, 09485858585', 0),
('DH013', 'ND03', 'PGG1', 'ND01', '2022-10-11 14:21:55', 'an khánh, ninh kiều, cần thơ', 1, 902000, 3, 'Bùi Công Minh, 0947574785', 0),
('DH014', 'ND03', 'PGG1', 'ND01', '2022-10-11 15:12:21', 'an khánh, ninh kiều, cần thơ', 1, 201000, 4, 'Bùi Công Minh, 0948848433', 0),
('DH017', 'ND03', 'PGG1', 'ND01', '2022-10-11 20:20:02', 'an khánh, ninh kiều, cần thơ', 2, 111000, 4, 'Bùi Công Minh, 0987654321', 0),
('DH018', 'ND03', 'PGG2', 'ND01', '2022-10-11 21:03:58', 'an khánh, ninh kiều, cần thơ', 2, 395000, 6, 'Bùi Công Minh, 0987654321', 0),
('DH019', 'ND03', 'PGG1', 'ND01', '2022-10-11 21:31:56', 'an khánh, ninh kiều, cần thơ', 2, 120000, 6, 'Bùi Công Minh, 0987654321', 0),
('DH02', 'ND02', 'PGG2', 'ND01', '2022-10-08 13:34:15', 'P.An Khánh, Q.Ninh Kiều, TP.Cần Thơ', 1, 578000, 4, 'Bùi Công Minh, 0924778854', 0),
('DH020', 'ND03', 'PGG1', 'ND01', '2022-10-11 21:49:16', 'an khánh, ninh kiều, cần thơ', 2, 57000, 6, 'Bùi Công Minh, 0987654321', 0),
('DH021', 'ND03', 'PGG1', 'ND01', '2022-10-11 21:51:29', 'an khánh, ninh kiều, cần thơ', 2, 50000, 4, 'Bùi Công a, 0987654321', 0),
('DH022', 'ND03', 'PGG1', 'ND01', '2022-10-11 21:55:02', 'an khánh, ninh kiều, cần thơ', 2, 70000, 0, 'Bùi Công Minh, 0987654321', 0),
('DH023', 'ND03', 'PGG1', 'ND01', '2022-10-11 21:56:49', 'an khánh, ninh kiều, cần thơ', 2, 80000, 5, 'Bùi Công a, 0987654321', 1),
('DH024', 'ND03', 'PGG1', 'ND01', '2022-10-11 21:58:24', 'an khánh, ninh kiều, cần thơ', 2, 57000, 4, 'Trần Minh a, 0987654321', 0),
('DH025', 'ND03', 'PGG1', 'ND01', '2022-10-11 22:00:01', 'an khánh, ninh kiều, cần thơ', 2, 57000, 4, 'Bùi Công a, 0987654321', 0),
('DH026', 'ND03', 'PGG1', 'ND01', '2022-10-11 22:04:23', 'an khánh, ninh kiều, cần thơ', 2, 77000, 2, 'Bùi Công a, 0987654321', 0),
('DH027', 'ND03', 'PGG1', 'ND01', '2022-10-11 22:12:18', 'an khánh, ninh kiều, cần thơ', 2, 50000, 5, 'Bùi Công a, 0987654321', 1),
('DH028', 'ND03', 'PGG1', 'ND01', '2022-10-12 10:05:23', 'an khánh, ninh kiều, cần thơ', 2, 95000, 4, 'as as, 0734758443', 0),
('DH029', 'ND03', 'PGG1', 'ND01', '2022-10-12 10:18:31', 'an khánh, ninh kiều, cần thơ', 2, 66000, 4, 'Trần Minh a, 0987654321', 0),
...
('DH040', 'ND03', 'PGG1', 'ND01', '2022-10-12 15:44:21', 'an khánh, ninh kiều, cần thơ', 2, 95000, 5, 'Bùi Công Minh, 0987654321', 1),
('DH041', 'ND03', 'PGG1', 'ND01', '2022-10-12 15:48:54', 'an khánh, ninh kiều, cần thơ', 2, 97500, 4, 'Bùi Công Minh, 0987654321', 0),
('DH042', 'ND03', 'PGG2', 'ND01', '2022-10-12 20:31:26', 'an khánh, ninh kiều, cần thơ', 2, 192000, 4, 'Bùi Công Minh, 0987654321', 1),
('DH043', 'ND03', 'PGG1', 'ND01', '2022-10-12 20:33:32', 'an khánh, ninh kiều, cần thơ', 1, 198000, 4, 'Bùi Công Minh, 0987654321', 0),
('DH05', 'ND01', 'PGG2', 'ND01', '2022-10-08 19:44:08', 'P.An Khánh, Q.Ninh Kiều, TP.Cần Thơ', 1, 543500, 5, 'Phan Trung Hậu, 0337474374', 0),
('DH06', 'ND01', 'PGG2', 'ND01', '2022-10-08 19:49:11', 'P.An Khánh, Q.Ninh Kiều, TP.Cần Thơ', 1, 115000, 4, 'Phan Trung Hậu, 0947475753', 0),
('DH07', 'ND03', 'PGG2', 'ND01', '2022-10-09 14:08:30', 'an khánh, ninh kiều, cần thơ', 1, 98000, 5, 'Trần Thị Diểm Ly, 0987654334', 0),
('DH08', 'ND03', 'PGG1', 'ND01', '2022-10-09 14:09:29', 'an khánh, ninh kiều, cần thơ', 1, 28000, 4, 'Trần Thị Diểm  Ly, 0965545434', 0),
('DH09', 'ND03', 'PGG1', 'ND01', '2022-10-11 14:08:38', 'an khánh, ninh kiều, cần thơ', 1, 185000, 1, 'Bùi Công Minh, 0948484875', 0);
...
('GH013', '2022-10-09', 'NGH1', 'DH06', '', 2),
('GH014', '2022-10-09', 'NGH1', 'DH06', '', 3),
('GH015', '2022-10-09', 'NGH1', 'DH06', '', 4),
('GH016', '2022-10-09', 'NGH1', 'DH08', '', 2),
('GH017', '2022-10-09', 'NGH1', 'DH08', '', 3),
('GH018', '2022-10-09', 'NGH1', 'DH08', '', 4),
('GH019', '2022-10-12', 'NGH1', 'DH043', '', 2),
('GH02', '2022-10-08', 'NGH3', 'DH03', '', 2),
('GH020', '2022-10-12', 'NGH1', 'DH042', '', 2),
('GH021', '2022-10-12', 'NGH1', 'DH041', '', 2),
...
('GH034', '2022-10-12', 'NGH1', 'DH029', '', 2),
('GH035', '2022-10-12', 'NGH1', 'DH028', '', 2),
('GH036', '2022-10-12', 'NGH1', 'DH025', '', 2),
('GH037', '2022-10-12', 'NGH1', 'DH024', '', 2),
('GH038', '2022-10-12', 'NGH1', 'DH021', '', 2),
('GH039', '2022-10-12', 'NGH1', 'DH020', '', 2),
('GH04', '2022-10-08', 'NGH3', 'DH01', '', 2),
('GH040', '2022-10-12', 'NGH1', 'DH019', '', 2),
('GH041', '2022-10-12', 'NGH1', 'DH018', '', 2),
('GH042', '2022-10-12', 'NGH1', 'DH017', '', 2),
('GH043', '2022-10-12', 'NGH1', 'DH014', '', 2),
('GH044', '2022-10-12', 'NGH1', 'DH013', '', 2),
('GH045', '2022-10-12', 'NGH1', 'DH012', '', 2),
('GH046', '2022-10-12', 'NGH1', 'DH011', '', 2),
('GH047', '2022-10-12', 'NGH1', 'DH043', '', 3),
('GH048', '2022-10-12', 'NGH1', 'DH042', '', 3),
('GH049', '2022-10-12', 'NGH1', 'DH041', '', 3),
('GH05', '2022-10-08', 'NGH3', 'DH04', '', 3),
('GH050', '2022-10-12', 'NGH1', 'DH038', '', 3),
('GH051', '2022-10-12', 'NGH1', 'DH030', '', 3),
('GH052', '2022-10-12', 'NGH1', 'DH029', '', 3),
('GH053', '2022-10-12', 'NGH1', 'DH028', '', 3),
('GH054', '2022-10-12', 'NGH1', 'DH025', '', 3),
('GH055', '2022-10-12', 'NGH1', 'DH024', '', 3),
('GH056', '2022-10-12', 'NGH1', 'DH021', '', 3),
('GH057', '2022-10-12', 'NGH1', 'DH020', '', 3),
('GH058', '2022-10-12', 'NGH1', 'DH019', '', 3),
('GH059', '2022-10-12', 'NGH1', 'DH018', '', 3),
('GH06', '2022-10-08', 'NGH3', 'DH04', '', 4),
('GH060', '2022-10-12', 'NGH1', 'DH017', '', 3),
('GH061', '2022-10-12', 'NGH1', 'DH014', '', 3),
('GH062', '2022-10-12', 'NGH1', 'DH013', '', 3),
('GH063', '2022-10-12', 'NGH1', 'DH043', '', 4),
('GH064', '2022-10-12', 'NGH1', 'DH041', '', 4),
('GH065', '2022-10-12', 'NGH1', 'DH042', '', 4),
('GH066', '2022-10-12', 'NGH1', 'DH038', '', 4),
('GH067', '2022-10-12', 'NGH1', 'DH037', '', 4),
('GH068', '2022-10-12', 'NGH1', 'DH031', '', 4),
('GH069', '2022-10-12', 'NGH1', 'DH031', '', 4),
('GH07', '2022-10-08', 'NGH3', 'DH03', '', 3),
('GH070', '2022-10-12', 'NGH1', 'DH030', '', 4),
('GH071', '2022-10-12', 'NGH1', 'DH029', '', 4),
('GH072', '2022-10-12', 'NGH1', 'DH028', '', 4),
('GH073', '2022-10-12', 'NGH1', 'DH025', '', 4),
('GH074', '2022-10-12', 'NGH1', 'DH024', '', 4),
('GH075', '2022-10-12', 'NGH1', 'DH020', '', 6),
('GH076', '2022-10-12', 'NGH1', 'DH019', '', 6),
('GH077', '2022-10-12', 'NGH1', 'DH018', '', 6),
('GH078', '2022-10-12', 'NGH1', 'DH021', '', 4),
('GH079', '2022-10-12', 'NGH1', 'DH017', '', 4),
('GH08', '2022-10-08', 'NGH3', 'DH03', '', 6),
('GH080', '2022-10-12', 'NGH1', 'DH014', '', 4),
('GH081', '2022-10-12', 'NGH1', 'DH026', '', 2),
('GH082', '2022-10-12', 'NGH1', 'DH010', '', 2),
('GH083', '2022-10-12', 'NGH1', 'DH012', '', 3),
('GH084', '2022-10-12', 'NGH1', 'DH012', '', 6),
('GH085', '2022-10-12', 'NGH1', 'DH011', '', 3),
('GH086', '2022-10-12', 'NGH1', 'DH011', '', 6),
